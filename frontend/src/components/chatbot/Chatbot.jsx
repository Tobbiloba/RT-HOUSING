  ...
  const handleChatbotResponse = userInput => {
    ...
    switch (userInput.toLowerCase()) {
      ...
      case 'available properties':
        ...
        (
          <>
            Sure we have several properties available. What city are you interested in. <br /> You can also click the link below to see available apartments
            <br />
            For more details, you can visit our <br /> <div className='pt-3'>
            <a href="/properties" className='mt-2 px-2 py-1 bg-slate-800'>See available properties</a>
            </div>
          </>
        );
        break
      ...
      case 'are pets allowed?':
        ...
        (
          <>
            The application process involves submitting an application form, undergoing a background check, and signing the lease agreement upon approval.
            <br />
            For more details, you can visit our <a href="https://example.com/application-process" className='border' target="_blank" rel="noopener noreferrer">application process page</a>.
          </>
        );
        break
      case 'goodbye':
  ...
  return (
    <div className="z-20 exo fixed bottom-10 text-[12px] right-10 max-w-[20rem]">
      {showChat ? (
        ...
        <div className="bg-white flex flex-col justify-center items-center cursor-pointer p-3 shadow-md" onClick={() => setShowChat(true)}>
