...
const Chatbot = () => {
  ...
  const handleChatbotResponse = userInput => {
    ...
    switch (userInput.toLowerCase()) {
      ...
      case 'available properties':
        response =
          'Sure, we have several properties available. What city are you interested in?'
        break
      case 'how much is the rent?':
        response =
      ...
      case 'are pets allowed?':
        response =
          'Pet policies vary by property. Please let us know if you have specific requirements regarding pets.'
        break
      case 'goodbye':
        response =
