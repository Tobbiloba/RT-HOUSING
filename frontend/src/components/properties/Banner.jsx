  ...
  return (
    <div className='w-[100%] exo relative h-[35rem] md:h-[26rem] pb-[1rem] items-center px-[7.5%]  flex flex-col justify-end'>
      ...
      <div className='container relative h-fit z-10 text-start bordr w-[100%] md:w-[100%] lg:max-w-[80rem] '>
              <div >
            <h1 className='text-[36px] md:text-[44px] lg:text-[60px] font-[600] text-white'>Searched Best Result</h1>
        ...
        <div className='grid shadow-md two-tone-background p-[.5rem] rounded-md mt-8 grid-cols-1 bg- md:grid-cols-2 lg:grid-cols-4 text-[15px] text-gray-500'>
            ...
            <h1 className='flex items-center text-[14px] border bg-white md:rounded-tr-md lg:rounded-none px-[1rem] h-[3.5rem] justify-between cursor-pointer'>In <img src='/down-arrow.png' className='w-5 h-5'/></h1>
            <h1 className='flex items-center border text-[14px] bg-white px-[1rem] md:rounded-bl-md lg:rounded-none h-[3.5rem] justify-between cursor-pointer'>Out <img src='/down-arrow.png' className='w-5 h-5'/></h1>
            <button className='flex items-center hover:border text-[14px] text-white h-[3.5rem] justify-center bg-slate-400 hover:bg-white rounded-b-md md:rounded-b-none hover:text-slate-400  lg:rounded-tr-md md:rounded-br-md'>Search Now</button>
        </div>
      </div>
