...
{/* <BsMenuButtonWide /> */}
const SortByOptions = ({filterState, toggleFilterOptions, viewMode, setViewMode}) => {
  ...
  return (
    <div className='p-3 flex flex-col exo md:flex-row gap-3 items- text-start'>
      <p className='text-[14px] text-slate-400'>12, 560 matches found for: "House" In "Manchester"</p>
      <div className='flex flex-row items-center gap-3 justify-end'>
         <div>
        <Dropdown data={sortOptions} state={sortBy} setState={setSortBy} height='w-40 h-10 rounded-sm border' />
      </div>
        {/* {
            viewMode === 'grid' &&
        } */}
