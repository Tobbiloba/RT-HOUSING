    ...
    <div className="exo flex items-centerw-[100%] justify-center mt-8">
      <div className="container px-[1rem]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          <div className="flex flex-col gap-4 ">
            ...
            <input
              ...
              className=" mt-6 border px-3 py-3 text-[13px]"
            />
            <button className="bg-slate-900 text-white text-[14px] mt-6 py-3 w-[60%]">
              SUBSCRIBE NOW
            </button>
          </div>
          <div>
        ...
        <div className="mt-10 flex flex-col items-center justify-center">
          ...
          <h1 className="mt-8 mb-4 text-center text-[15px]">
            COPYRIGHT &copy; <span>RT HOUSING</span> || ALL RIGHTS RESERVED
          </h1>
        </div>
      </div>
    </div>
