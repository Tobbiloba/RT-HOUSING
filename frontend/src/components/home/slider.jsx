...
const Slider = () => {
  ...
  <div className="slider-container absolute top-0 left-0">
      ...
      >
        <div style={{ backgroundImage: 'url("/img-05.jpg")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }} className='slider-item h-[67.5rem] md:h-[65rem] lg:h-[54rem] w-[100vw]'></div>
        <div style={{ backgroundImage: 'url("/img-05.jpg")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }} className='slider-item h-[67.5rem] md:h-[65rem] lg:h-[54rem] w-[100vw]'></div>
        <div style={{ backgroundImage: 'url("/img-05.jpg")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }} className='slider-item h-[67.5rem] md:h-[65rem] lg:h-[54rem] w-[100vw]'></div>
      </div>
    </div>
