...
//   const [totalMonthlyPayment, setTotaMonthlyPayment] = useState(1386.41)
...
const calculateEstimates = () => {
    ...
    const totalLoanAmount = roundTo2DecimalPlaces(monthlyPayment * numberOfPayments);
    ...
    <div className="pt-28 flex flex-col justify-center items-center exo md:px-[1rem]">
      ...
      <div className="mt-28 w-[100%] md:min-w-[50rem] md:w-[70%] flex flex-col items-center justify-center gap-16 py-16 bg-slate-50 px-4 md:px-12">
        ...
        <div className="border w-[100%] flex flex-col md:flex-row justify-evenly bg-white px-6 py-12">
            <div>
                <p className="text-slate-500 text-center md:text-start text-[14px]">DOWN PAYMENT%</p>
                <h1 className="text-xl font-[600] mt-2 text-center">${totalDownPayment}</h1>
            </div>
            <div>
                <p className="text-slate-500 text-center md:text-start mt-10 md:mt-0 text-[14px]">MONTHLY PAYMENT%</p>
                <h1 className="text-xl font-[600] text-center mt-2">${totalMonthlyPayment}</h1>
            </div>
            <div>
                <p className="text-slate-500 text-center md:text-start mt-10 md:mt-0 text-[14px]">TOTAL LOAN AMOUNT</p>
                <h1 className="text-xl font-[600] text-center mt-2">${totalLoanAmount}</h1>
            </div>
        </div>
      </div>
    </div>
