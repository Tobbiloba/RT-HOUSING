...
// import NavTest from '../components/MenuTest';
// import { AnimatedTabs } from '../components/NavTest2';
...
const Homescreen = () => {
  ...
  const checkoutDate = checkOutDate?.$d.toDateString();
  // const formattedDate = checkInDate(dateObject.$d).format('YYYY-MM-DD');
  return (
...
/> */}
      ...
      <div className="md:h-[50rem] h-[61rem] md:bottom-20 lg:bottom-0 w-[90%] lg:w-[33.5rem] bg-white z-[50] relative p-7 rounded-md">
