...
const featureList = [
    {
      ...
      description: "Explore a curated selection of high-quality accommodations. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      img: "http://amentotech.com/htmls/tenanto/images/work/img-01.jpg"
    },
    {
      title: "Explore Accommodation Details",
      description: "Gain in-depth insights into accommodation options. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      img: "http://amentotech.com/htmls/tenanto/images/work/img-02.jpg"
    },
    {
      title: "Secure Your Reservation",
      description: "Effortlessly book your preferred accommodation. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      img: "http://amentotech.com/htmls/tenanto/images/work/img-03.jpg"
    },
    {
      title: "Indulge in a Memorable Stay",
      description: "Experience comfort and luxury during your stay. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
  ...
  return (
    <div className="flex flex-col items-center exo">
      ...
      <div className="flex flex-row mt-16 gap-3 container justify-center px-[1rem] md:mx-[7.5%]">
        ...
        <div className="border flex lg:hidden h-fit p-2 text-slate-400 rounded-sm" onClick={() => toggleDrawer(anchor, false)}>
            <IoSettingsOutline />
        </div>
        {
            isDesktop && 
