...
const items = ['Furniture', 'Home', 'Rent', 'Brand', 'Trusted', 'Refund']
...
const GroupAvatars = () => {
  return (
    <AvatarGroup max={4}>
      ...
      <Avatar
        alt="Travis Howard"
        src="https://images.unsplash.com/photo-1534030347209-467a5b0ad3e6?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8bWFsZXxlbnwwfHwwfHx8MA%3D%3D"
      />
      <Avatar
        alt="Cindy Baker"
      ...
      <Avatar
        alt="Agnes Walker"
        src="https://images.unsplash.com/photo-1480429370139-e0132c086e2a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fG1hbGV8ZW58MHx8MHx8fDA%3D"
      />
      <Avatar
        alt="Trevor Henderson"
        src="https://images.unsplash.com/photo-1566492031773-4f4e44671857?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fG1hbGV8ZW58MHx8MHx8fDA%3D"
      />
    </AvatarGroup>
  )
}
      ...
      >
        ...
        <div className="container px-[1rem] flex flex-col justify-between my-[2rem] items-center">
          ...
          <div className="w-[100%]  h-[100%] lg:h-fit flex flex-col z-10 lg:flex-row justify-between">
            <div className="w-fit">
              <h1 className="bg-white text-4xl pl-4 pr-12 py-2 rounded-r-xl rounded-tl-xl font-[600]">
                We Are Here
              </h1>
              <h1 className="bg-white text-4xl pl-4 pr-12 py-1 rounded-br-xl w-fit font-[600]">
                For You.
              </h1>
            ...
            <div className="">
              <div className="flex gap-5 mb-2 justify-between text-white">
                <h1 className="text-center text-3xl">
                  100+ <br />{' '}
                  <p className="text-[14px]">Available Properties</p>
                </h1>
                <h1 className="text-center text-3xl">
                  5k+ <br /> <p className="text-[14px]">Satisfied Customer</p>
                </h1>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6">
                {items.map((item, index) => (
                  <p
                    key={index}
                    className="bg-black/60 text-white text-center px-4 p-2 text-[13px]"
                  >
                    {item}
                  </p>
                ))}
      ...
      <div className="container px-[1rem] mt-[5rem]">
        <div className="flex flex-col items-center lg:flex-row justify-between">
          ...
          <div className="lg:w-6/12 mt-8 lg:mt-0 flex flex-col gap-10 justify-between">
            <div className="">
              <p className="text-slate-500 text-[16px] font-[600]">
                Our Management
              </p>
              ...
              <p className="mt-5 font-[600] text-slate-500">
                "Success is not just about making profits; it's about creating
                lasting relationships and leaving a positive impact on the
                world."
              </p>
              <p className="mt-5 text-[14px] text-slate-500">
                Peter Hendrick, our visionary leader, brings a wealth of
                experience and passion to our team. With over two decades in the
                real estate industry, Peter has not only witnessed but actively
                shaped the evolution of property management. His profound
                understanding of market dynamics, coupled with an unwavering
                commitment to excellence, positions him as a guiding force in
                our journey. Peter's leadership philosophy is not just about
                achieving short-term goals; it's about laying the foundation for
                a sustainable and thriving future. As a seasoned professional,
                Peter is dedicated to fostering a collaborative and innovative
                work environment. He believes in the power of teamwork and
                continually invests in the professional growth of our staff.
                Peter's vision extends beyond the conventional boundaries of
                property management – he envisions a future where our rental
                spaces aren't just shelters; they are vibrant communities that
                enhance the quality of life for our tenants.
