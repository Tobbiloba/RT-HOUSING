  ...
  return (
    <div className="p-[1rem] md:p-[2rem] exo">
      <div className=" bg-slate-700 p-[1rem] md:p-[2rem]  ">
        <h1 className="text-3xl text-slate-400">ADD EMPLOYEE</h1>

        <div className="flex flex-row gap-4 mt-5 text-slate-400">
          <h1 className="border-b-2 p-2 border-b-slate-500 cursor-pointer">
            General
          </h1>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 mt-12  justify-between gap-y-16 gap-x-12">
          ...
          <div className="w-[100%] relative flex flex-row gap-[2rem]  justify-between items-center md:pr-[5%] pr-[1rem]">
            ...
            <div className="h-[3rem] relative flex-1  md:min-w-[10rem] lg:max-w-[35rem] flex flex-row gap-5 items-center text-white">
            <Dropdown
              data={options}
              state={role}
              setState={setRole}
        ...
        <div className="mt-16 flex gap-8 flex-row justify-end">
          ...
          <button className="border px-4 py-3 text-slate-300 border-slate-500" >ADD EMPLOYEE</button>
        </div>
      </div>
